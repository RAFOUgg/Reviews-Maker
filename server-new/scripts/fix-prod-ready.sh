...
echo "Locking .env permission and owner to current user"
...
echo "Reloading pm2 ecosystem (if pm2 available and ecosystem file exists)"
...
echo "Done. Please rotate secrets immediately if they were exposed in the repo history."
