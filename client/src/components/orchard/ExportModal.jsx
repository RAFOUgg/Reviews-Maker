...
export default function ExportModal({ onClose }) {
    const { reviewData, config } = useOrchardStore();
    ...
    return (
        <>
            ...
            <motion.div
                ...
                className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-[60] w-full max-w-2xl bg-white dark:bg-gray-800 rounded-2xl shadow-2xl overflow-hidden"
            >
                {/* Header */}
