                ...
                <div className="space-y-3">
                    {presets.map((preset) => (
                        <motion.div
                            ...
                            className={`p-4 rounded-xl border-2 transition-all ${activePreset === preset.id ? 'border-purple-500 bg-purple-50 dark:bg-purple-900/20 dark:border-purple-500' : 'border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800' }`}
                        >
