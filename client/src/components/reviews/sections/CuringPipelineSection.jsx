                        ...
                        <div className="grid grid-cols-3 md:grid-cols-6 gap-2">
                            {TIMELINE_INTERVALS.map(interval => (
                                <button
                                    ...
                                    className={`px-3 py-2 rounded-xl font-medium text-sm transition-all ${config.timelineInterval === interval.id
                ...
                <div className="grid grid-cols-2 gap-3">
                    {CURING_TYPES.map(type => (
                        <button
                            ...
                            className={`p-4 rounded-xl text-center transition-all ${config.type === type.id
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-2">
                        {CONTAINER_TYPES.map(container => (
                            <button
                                ...
                                className={`p-3 rounded-xl transition-all ${conditions.containerType === container.id
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-5 gap-2">
                            {PACKAGING_TYPES.map(packaging => (
                                <button
                                    ...
                                    className={`p-3 rounded-xl transition-all ${conditions.packagingType === packaging.id
                        ...
                        <div className="grid grid-cols-5 gap-2">
                            {OPACITY_LEVELS.map(opacity => (
                                <button
                                    ...
                                    className={`p-3 rounded-xl transition-all ${conditions.opacityLevel === opacity.id
                                            ? 'bg-purple-500 text-white shadow-lg'
                                            : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
                                        }`}
                                >
