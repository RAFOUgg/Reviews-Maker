    ...
    return (
        <div className="space-y-6">
            ...
            <motion.button
                ...
                className="w-full py-3 px-4 bg-gradient-to-r text-white rounded-xl font-medium shadow-lg hover:shadow-purple-500/50 transition-all flex items-center justify-center gap-2"
            >
                ...
                <div className="space-y-3">
                    {presets.map((preset) => (
                        <motion.div
                            ...
                            className={`p-4 rounded-xl border-2 transition-all ${activePreset === preset.id ? ' dark:' : 'border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800' }`}
                        >
                            ...
                            <div className="flex gap-2">
                                <motion.button
                                    ...
                                    className="flex-1 px-3 py-2 text-white rounded-lg text-sm font-medium hover: transition-colors"
                                >
                                    Charger
                                </motion.button>
                        ...
                        >
                            ...
                            <div className="space-y-4">
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-900 text-gray-900 dark:text-white focus:ring-2 focus: focus:border-transparent"
                                        autoFocus
                                    />
                                </div>
                                ...
                                <div>
                                    ...
                                    <textarea
                                        ...
                                        rows={3}
                                        className="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-900 text-gray-900 dark:text-white focus:ring-2 focus: focus:border-transparent resize-none"
                                    />
                                </div>
                            </div>
                            ...
                            <div className="flex gap-3 mt-6">
                                ...
                                <motion.button
                                    ...
                                    className="flex-1 px-4 py-2 bg-gradient-to-r text-white rounded-lg font-medium shadow-lg hover:shadow-purple-500/50 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                                >
