...
export default function UserProfileDropdown() {
    ...
    const dropdownContent = isOpen && (
        <>
            ...
            />
            <div
                className="fixed w-64 bg-[rgba(var(--color-primary),0.1)] backdrop-blur-xl rounded-xl shadow-2xl border border-[rgba(var(--color-primary),0.3)] z-[9999] overflow-hidden"
                style={{
                    top: `${position.top}px`,
                    right: `${position.right}px`
                }}
            >
                <div className="p-4 border-b border-[rgba(var(--color-primary),0.3)] bg-gradient-to-br from-[rgb(var(--color-primary))] to-[rgb(var(--color-accent))]">
                ...
                <div className="py-2">
                    <Link to="/library" className="flex items-center gap-3 px-4 py-3 hover:bg-[rgba(var(--color-primary),0.2)] transition-colors" onClick={() => setIsOpen(false)}>
                    ...
                    <Link to="/stats" className="flex items-center gap-3 px-4 py-3 hover:bg-[rgba(var(--color-primary),0.2)] transition-colors" onClick={() => setIsOpen(false)}>
                    ...
                    <Link to="/settings" className="flex items-center gap-3 px-4 py-3 hover:bg-[rgba(var(--color-primary),0.2)] transition-colors" onClick={() => setIsOpen(false)}>
                        ...
                        <div>
                            <p className="font-medium text-[rgb(var(--text-primary))]">Paramètres</p>
                            <p className="text-xs text-[rgb(var(--text-secondary))] opacity-80">Préférences & thème</p>
                        </div>
                    </Link>
                </div>
                <div className="border-t border-[rgba(var(--color-primary),0.3)] py-2">
    ...
    return (
        <>
            <button ref={buttonRef} onClick={() => setIsOpen(!isOpen)} className="flex items-center gap-2 p-2 rounded-lg hover:bg-[rgba(var(--color-primary),0.2)] transition-colors">
