...
const RDRBanner = () => {
    ...
    return (
        <div
            id="rdr-banner"
            className="bg-gradient-to-r from-amber-500/10 via-orange-500/10 to-amber-500/10 backdrop-blur-md border-b border-amber-500/20 text-white shadow-lg fixed top-0 left-0 right-0 z-[10000]">
