...
/**
 * Schéma du wizard pour Hash. `path` doit matcher flattenHashFormData()
 * (client/src/utils/formDataFlattener.js) : visuel est NESTED sous `formData.visuel`
 * (contrairement à Fleur où le visuel est flat) — cf. VisualSection.jsx qui lit `data.visuel`.
 * Séparation et Curing sont des pipelines complexes non linéarisables : étapes "handoff".
 */
export function getHashWizardQuestions() {
    return [
        {
            ...
            required: true, maxLength: 100, placeholder: 'Nom du hash',
        },
        {
            id: 'hashmaker', section: 'infos', title: 'Informations générales',
            label: 'Qui est le hashmaker ?',
        ...
        {
            id: 'separation-handoff', section: 'separation', title: 'Pipeline Séparation',
            label: 'Configurer la pipeline de séparation (optionnel)',
            widget: WIZARD_WIDGETS.HANDOFF, handoffTarget: 'separation', ctaLabel: 'Configurer la séparation',
        },
        ...
        { id: 'pureteVisuelle', section: 'visual', title: 'Visuel & Technique', label: 'Notez la pureté visuelle (absence de contaminants)', widget: WIZARD_WIDGETS.SLIDER, path: { kind: 'nested', section: 'visuel', field: 'pureteVisuelle' } },
...
export default getHashWizardQuestions
