                    ...
                    <div className="mb-8">
                        ...
                        {aromas.length > 0 && (
                            <div className="mb-4">
                                ...
                                <div className="flex flex-wrap gap-2">
                                    {aromas.map((aroma, i) => (
                                        <span key={i} className={`px-3 py-1 rounded-full text-sm font-semibold ${isDark ? 'bg-purple-900 text-purple-200' : 'bg-purple-100 text-purple-900'}`}>
                                            {aroma}
                                        </span>
                                    ))}
                                </div>
                        ...
                        {tastes.length > 0 && (
                            <div className="mb-4">
                                ...
                                <div className="flex flex-wrap gap-2">
                                    {tastes.map((taste, i) => (
                                        <span key={i} className={`px-3 py-1 rounded-full text-sm font-semibold ${isDark ? 'bg-blue-900 text-blue-200' : 'bg-blue-100 text-blue-900'}`}>
                                            {taste}
                                        </span>
                                    ))}
                                </div>
