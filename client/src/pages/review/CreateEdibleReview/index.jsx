...
export default function CreateEdibleReview() {
    ...
    const handleSave = async ({ silent = false, skipNavigate = false } = {}) => {
        ...
        try {
            ...
            const rawPhotos = savedReview?.edibleReview?.photos
            if (rawPhotos) {
                let parsedPhotos = []
    ...
    // au-delà, plus besoin de gate sur nomProduit (qui bloquait silencieusement l'autosave
                    ...
                    >
                        <div className="flex items-center justify-between gap-3 mb-6">
                            ...
                            {sections[currentSection].id === 'recipe' && (
                                <ChainToggleButton reviewId={id} reviewType="edible" />
                            )}
                        </div>
