                    ...
                    <div>
                        ...
                        {photos.length < 4 && (
                            <div className="grid grid-cols-2 gap-3">
                                <label className="flex items-center justify-center gap-2 px-3 py-3 border-2 border-dashed border-white/20 rounded-xl cursor-pointer hover:border-green-500/50 bg-white/5 hover:bg-green-500/10 transition-all backdrop-blur-sm">
