  ...
  const handleLike = (e) => {
    ...
    return (
      <div className="min-h-screen bg-app relative">
        <div className="container-glass mx-auto px-4 py-8 relative z-10">
          ...
          <h1 className="text-4xl md:text-5xl font-black text-title mb-4 drop-shadow-lg">
            🌿 Galerie Publique
          </h1>
    ...
    if (rating >= 4) return 'from-orange-500 to-red-500';
          ...
          <motion.div
            ...
            whileHover={{ y: -5 }}
            className="w-full pl-10 pr-4 py-3 rounded-xl bg-panel border border-white/10 text-title placeholder-subtitle focus:outline-none focus:ring-2 focus:ring-gray-600"
            ...
            <LiquidCard className="overflow-hidden">
              ...
              <div className="relative aspect-square overflow-hidden">
                <img
                  ...
                  className={`px-4 py-2 rounded-xl font-medium whitespace-nowrap transition-all ${selectedType === type.id ? 'bg-panel text-title' : 'bg-card text-subtitle hover:brightness-105'
                    }`}
                />
                ...
                {/* Rating */}
                className="px-4 py-2 rounded-xl bg-panel border border-white/10 text-title focus:outline-none"
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                <button
                  ...
                  className="p-2 rounded-xl bg-panel text-title hover:brightness-105"
                >
              ...
              <div className="p-4">
                ...
                <p className="text-sm text-subtitle truncate mb-3">
